...
project = 'hierts'
copyright = '2022, Olivier Sprangers'
...
def linkcode_resolve(domain, info):
    ...
    fn = relpath(fn, start=dirname(dirname(hierts.__file__)))
    return "https://github.com/elephaint/hierts/blob/main/src/%s%s" % (fn, linespec)
